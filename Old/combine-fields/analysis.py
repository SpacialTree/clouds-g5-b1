...
### Entire maps
#immoments(imagename='spw23_H2CO/g5.H2CO.spw23.im',moments=[0],chans='198~447',outfile='analysis/g5.mom0.tot.H2CO.spw23.im')
#immoments(imagename='spw25_H2CO/g5.H2CO.spw25.im',moments=[0],chans='198~447',outfile='analysis/g5.mom0.tot.H2CO.spw25.im')

imsmooth(imagename='spw23_H2CO/g5.mom0.tot.H2CO.spw23.im', targetres=True, major='35arcsec', minor='35arcsec', pa=0, outfile='temperatures/mom0.tot.smo.H2CO.spw23.im')
imsmooth(imagename='spw25_H2CO/g5.mom0.tot.H2CO.spw25.im', targetres=True, major='35arcsec', minor='35arcsec', pa=0, outfile='temperatures/mom0.tot.smo.H2CO.spw25.im')

immath(imagename='temperatures/mom0.tot.smo.H2CO.spw23.im', mode='evalexpr', expr='1.222e6*IM0/218.760066^2/40^2', outfile='temperatures/mom0.tot.smoK.H2CO.spw23.im')
immath(imagename='temperatures/mom0.tot.smo.H2CO.spw25.im', mode='evalexpr', expr='1.222e6*IM0/218.222192^2/40^2', outfile='temperatures/mom0.tot.smoK.H2CO.spw25.im')

imhead(imagename='temperatures/mom0.tot.smoK.H2CO.spw23.im', mode='put', hdkey='bunit', hdvalue='K.km/s')
imhead(imagename='temperatures/mom0.tot.smoK.H2CO.spw25.im', mode='put', hdkey='bunit', hdvalue='K.km/s')

imregrid(imagename='temperatures/mom0.tot.smoK.H2CO.spw23.im', template='temperatures/mom0.tot.smoK.H2CO.spw25.im',axes=[0,1],interpolation='cubic',output='temperatures/23t25.tot.im',overwrite=True)
##check 3 sigma
immath(imagename=['temperatures/23t25.tot.im','temperatures/mom0.tot.smoK.H2CO.spw25.im'], mode='evalexpr', expr='IM0 / IM1 [IM0>0.1&&IM1>0.2]', outfile='temperatures/smoothratio.tot.im')
imhead(imagename='temperatures/smoothratio.tot.im', mode='put', hdkey='bunit', hdvalue='')

immath(imagename='temperatures/smoothratio.tot.im', mode='evalexpr', expr='(590 * IM0^2 + 2.88 * IM0 + 23.4)', outfile='temperatures/smoothtemp.tot.im')
imhead(imagename='temperatures/smoothtemp.tot.im', mode='put', hdkey='bunit', hdvalue='K')
...
imsmooth(imagename='spw17_12CO/g5a.mom0.tot.12CO.spw17.im', targetres=True, major='40arcsec', minor='40arcsec', pa=0, outfile='analysis/g5a.sm.mom0.tot.12CO.spw17.im')
imsmooth(imagename='spw17_12CO/g5a.mom0.L.12CO.spw17.im', targetres=True, major='40arcsec', minor='40arcsec', pa=0, outfile='analysis/g5a.sm.mom0.L.12CO.spw17.im')
imsmooth(imagename='spw17_12CO/g5a.mom0.R.12CO.spw17.im', targetres=True, major='40arcsec', minor='40arcsec', pa=0, outfile='analysis/g5a.sm.mom0.R.12CO.spw17.im')

immath(imagename='analysis/g5a.sm.mom0.tot.12CO.spw17.im', mode='evalexpr', expr='1.222e6*IM0/230.538000^2/40^2', outfile='analysis/g5a.smK.mom0.tot.12CO.spw17.im')
immath(imagename='analysis/g5a.sm.mom0.L.12CO.spw17.im', mode='evalexpr', expr='1.222e6*IM0/230.538000^2/40^2', outfile='analysis/g5a.smK.mom0.L.12CO.spw17.im')
immath(imagename='analysis/g5a.sm.mom0.R.12CO.spw17.im', mode='evalexpr', expr='1.222e6*IM0/230.538000^2/40^2', outfile='analysis/g5a.smK.mom0.R.12CO.spw17.im')

imhead(imagename='analysis/g5a.smK.mom0.tot.12CO.spw17.im', mode='put', hdkey='bunit', hdvalue='K.km/s')
imhead(imagename='analysis/g5a.smK.mom0.L.12CO.spw17.im', mode='put', hdkey='bunit', hdvalue='K.km/s')
imhead(imagename='analysis/g5a.smK.mom0.R.12CO.spw17.im', mode='put', hdkey='bunit', hdvalue='K.km/s')
#N(H2) = 2e20 * M0 / 0.8
#cm-2
immath(imagename='analysis/g5a.smK.mom0.tot.12CO.spw17.im',mode='evalexpr',expr='2e20 * IM0 / 0.8',outfile='analysis/g5a.tot.h2dense.im')
immath(imagename='analysis/g5a.smK.mom0.L.12CO.spw17.im',mode='evalexpr',expr='2e20 * IM0 / 0.8',outfile='analysis/g5a.L.h2dense.im')
immath(imagename='analysis/g5a.smK.mom0.R.12CO.spw17.im',mode='evalexpr',expr='2e20 * IM0 / 0.8',outfile='analysis/g5a.R.h2dense.im')

imhead(imagename='analysis/g5a.tot.h2dense.im', mode='put', hdkey='bunit', hdvalue='H2.cm-2')
imhead(imagename='analysis/g5a.L.h2dense.im', mode='put', hdkey='bunit', hdvalue='H2.cm-2')
imhead(imagename='analysis/g5a.R.h2dense.im', mode='put', hdkey='bunit', hdvalue='H2.cm-2')
